...
var WorkorderBox = React.createClass({
	...
	render: function () {
		...
		var customerBox = this.state.showCustomer ? React.createElement(CustomerBox, { onSelect: this.toggleCustomer,
			data: workorder.customer }) : null;

		var act = workorder.activities;
		act = _.sortBy(act, "createdAt").reverse();
		var commentBox = this.state.showComments ? React.createElement(CommentBox, { onAdd: this.onAddComment,
			comments: act
		}) : null;
...
},{"./commentBox":161,"./customerBox":162,"react":159,"underscore":160}],164:[function(require,module,exports){
var React = require('react');
...
},{"./workorderBox":163,"react":159}],165:[function(require,module,exports){
var $ = require('jquery');
var React = require('react');
...
},{"./components/workorderBoxList":164,"jquery":2,"react":159,"react-dom":3}]},{},[165]);
