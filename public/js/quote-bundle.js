...
},{"./customerBox":161,"react":160}],163:[function(require,module,exports){
var React = require('react');
...
var CustomerLookup = React.createClass({
	...
	render: function () {
		...
		var customerBox = c ? React.createElement(
			...
			null,
			' ',
			React.createElement(CustomerBox, { className: 'customer-box-selected col-xs-12 col-sm-6 col-md-4 customer-box', key: c._id, data: c, onSelect: this.changeSelection }),
			React.createElement(
				'div',
